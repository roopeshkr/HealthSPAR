...
export class RescheduleAppointmentComponent implements OnInit {
  ...
  constructor(private appointmentService: AppointmentService, private formBuilder: FormBuilder, private hospitalService: HospitalService,) {
